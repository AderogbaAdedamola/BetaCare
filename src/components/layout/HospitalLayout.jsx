...
export function HospitalLayout({ children }) {
  ...
  const navigation = [
    ...
    { name: "Manage Staff", href: "/hospital/staff", icon: ShieldCheck },
    { name: "Audit Logs", href: "/hospital/audit-log", icon: ClipboardList },
      ...
      <aside className="hidden lg:flex flex-col w-72 bg-card border-r border-border shrink-0 z-30 h-screen sticky top-0">
        ...
        <div className="h-[76px] flex items-center gap-3 px-6 border-b border-border">
          ...
          >
            ...
            <span className="text-[10px] ml-1.5 px-1.5 py-0.5 bg-primary/10 text-primary font-bold rounded">HOSPITAL</span>
          </span>
        </div>
